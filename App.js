...
/* const AnotherComponet=()=>(<h2>Thisn is AnotherComponet</h2>);
const Header = () => {
    return (
      <div className="Title" key="title">
        <h1 style={{color:"blue"}} key="h1">This is h1 tag</h1>
    ...
    return(
        <div className="header">
            <div className="logo-container">
                <img className="logo" 
                src="https://img.freepik.com/free-vector/delivery-service-man-scooter_23-2148494201.jpg?size=626&ext=jpg&ga=GA1.1.1106169349.1714374909&semt=ais"/>
            </div>
